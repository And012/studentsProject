        ...
        <section className="items">
          <div className="item_1">
            ...
            <table className="table">
              ...
              <tr>
                <th>Ծննդավայր</th>
                <td>
                  Լոր, Զանգեզուրի գավառ, Ելիզավետպոլի նահանգ, Ռուսական
                  կայսրություն
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <th>Գերեզման</th>
                <td>
                  Գերեզման Համո Սահյանի և Կոմիտասի անվան զբոսայգու պանթեոն
                </td>
              </tr>
              <tr>
          ...
          <div className="items_3">
            <div className="item_3">
              <ul className="ul">
                <li>
                  <a href="#" onClick={() => navigate("kensagrutyun")}>
                    Կենսագրություն
                  </a>
                </li>
                <li>
                  <a href="#" onClick={() => navigate("grakanGorcuneutyun")}>
                    Գրական գործունեություն
                  </a>
                </li>
                <li>
                  <a href="#" onClick={() => navigate("banastexcutyunner")}>
                    Բանաստեղծություններ
                  </a>
                </li>
                <li>
                  <a href="#" onClick={() => navigate("sahyaniMasin")}>
                    Համո Սահյանի մասին
                  </a>
                </li>
                <li>
                  <a href="#" onClick={() => navigate("hishatak")}>
                    Հիշատակ
                  </a>
                </li>
              </ul>
